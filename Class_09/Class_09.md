...
Here we examined samples from 569 patients
...
Looks like we need to use `scale = TRUE`here as our data are all over
the shop …
...
![](Class_09_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
